...
export default function Desktop() {
  ...
  return (
    <div className="relative min-h-screen bg-[#050a14] flex flex-col items-center justify-center overflow-hidden">
      ...
      {open && <Window id={open} title={`${open} • MAG CORE V0.7 • 1.5m VR`} onClose={() => setOpen(null)}><div className="text-white/80">Module {open} — bordure blanche 2px, safe zone ±15°, focus 1.5m, texte 1.2m readable.<br/>Rouge maîtrisé #A51205 • Quantum Fusion</div></Window>}
      <div className="absolute bottom-6 font-mono text-[8px] text-white/20">MAG CORE ENGINE • QUANTUM FUSION • V0.7 • NO WATERMARK • 1.5m VR</div>
    </div>
  );
}
